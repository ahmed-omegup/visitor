...
import lib.legacy.PrefixNotationPrinter;
...
abstract class PrefixNotationPrinterTestBase<E> extends TestBase<E> {
    ...
    void rendersTraversalExpressionInPrefixNotation() {
        assertEquals(
            "(?: (&& (< x 10) (! (== 1 0))) (+ (- 7 2) (* (/ 8 2) (% 9 4))) (call f (^ 2 3) (!= 5 6) (> 7 1) (<= 2 2) (>= 3 3) (|| 0 1) (neg 4)))",testSupport.v.prefixNotationPrinter().apply(testSupport.sampleTraversalExpression())
        );
    }
}
