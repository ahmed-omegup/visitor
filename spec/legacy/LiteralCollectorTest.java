...
import lib.legacy.LiteralCollector;
...
abstract class LiteralCollectorTestBase<E> extends TestBase<E> {
    ...
    void collectsLiteralsInTraversalOrder() {
        assertEquals(
            of("10", "1", "0", "7", "2", "8", "2", "9", "4", "2", "3", "5", "6", "7", "1", "2", "2", "3", "3", "0", "1", "4"),testSupport.v.literalCollector().apply(testSupport.sampleTraversalExpression())
        );
    }
}
