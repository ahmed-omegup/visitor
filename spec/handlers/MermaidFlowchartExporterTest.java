...
class MermaidFlowchartExporterTest {
    ...
    void exportsSimpleFlowchart() {
        assertEquals(
            "flowchart TD\n"
                ...
                + "  n2[\"Literal(2)\"]\n"
                + "  n0 --> n2\n",
            new MermaidFlowchartExporter().handle(lib.expression.ExpressionFactory.addition(lib.expression.ExpressionFactory.variableReference("x"), lib.expression.ExpressionFactory.literal("2")))
        );
    }
    ...
    void reusesExistingNodeForSharedExpressionReference() {
        ...
        var chart = new MermaidFlowchartExporter().handle(lib.expression.ExpressionFactory.addition(shared, shared));
