    ...
    void exportsNodesAsCsvRows() {
        assertEquals(
            "path,type,detail\n"
                ...
                + "\"0.1\",\"Literal\",\"1\"\n"
                + "\"0.2\",\"Literal\",\"2\"\n",
            new CsvNodeExporter().handle(lib.expression.ExpressionFactory.functionCall(lib.expression.ExpressionFactory.variableReference("sum"), lib.expression.ExpressionFactory.literal("1"), lib.expression.ExpressionFactory.literal("2")))
        );
    }
