...
public class ComparisonOperatorCounter extends AbstractExpressionFunction<Integer> {
    ComparisonOperatorCounter() {}
    ...
    public Integer visit(Equality expression) { return 1 + branch(expression.left, expression.right); }
    public Integer visit(Inequality expression) { return 1 + branch(expression.left, expression.right); }
    public Integer visit(LessThan expression) { return 1 + branch(expression.left, expression.right); }
    public Integer visit(GreaterThan expression) { return 1 + branch(expression.left, expression.right); }
    public Integer visit(LessThanOrEqual expression) { return 1 + branch(expression.left, expression.right); }
    public Integer visit(GreaterThanOrEqual expression) { return 1 + branch(expression.left, expression.right); }
    public Integer visit(Conjunction expression) { return branch(expression.left, expression.right); }
    public Integer visit(Disjunction expression) { return branch(expression.left, expression.right); }
