...
public class LeafDepthSequenceBuilder extends AbstractExpressionFunction<List<Integer>> {
    LeafDepthSequenceBuilder() {}
    private int depth;
    ...
    public List<Integer> visit(Literal expression) { depths.add(depth); return null; }
