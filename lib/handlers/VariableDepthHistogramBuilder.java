...
public class VariableDepthHistogramBuilder implements Visitor<Map<Integer, Integer>> {
    ...
    public Map<Integer, Integer> visit(VariableReference expression) {
            if (!active) { return handle(expression); } histogram.put(depth, histogram.getOrDefault(depth, 0) + 1); return null; }
