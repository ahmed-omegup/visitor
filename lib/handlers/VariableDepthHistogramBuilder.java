...
public class VariableDepthHistogramBuilder {
    ...
    private void collect(Expression expression, int depth, Map<Integer, Integer> histogram) {
        expression.accept(new Visitor<Void>() {
            ...
            public Void visit(VariableReference expression) { histogram.put(depth, histogram.getOrDefault(depth, 0) + 1); return null; }
