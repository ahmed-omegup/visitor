...
public class LeafPathCollector extends AbstractExpressionFunction<List<String>> {
    LeafPathCollector() {}
    private String path;
    ...
    public List<String> visit(Literal expression) { paths.add(path); return null; }
    public List<String> visit(VariableReference expression) { paths.add(path); return null; }
