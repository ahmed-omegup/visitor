...
public class ConditionalDepthSequenceBuilder extends AbstractExpressionFunction<List<Integer>> {
    ConditionalDepthSequenceBuilder() {}
    private int depth;
    ...
    public List<Integer> visit(Conditional expression) { depths.add(depth);
