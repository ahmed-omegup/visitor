...
public class FunctionCallDepthSequenceBuilder extends AbstractExpressionFunction<List<Integer>> {
    FunctionCallDepthSequenceBuilder() {}
    private int depth;
    ...
    public List<Integer> visit(FunctionCall expression) { depths.add(depth);
