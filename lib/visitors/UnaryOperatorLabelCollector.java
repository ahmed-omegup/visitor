...
public class UnaryOperatorLabelCollector extends AbstractExpressionFunction<List<String>> {
    ...
    public List<String> visit(Negation expression) { labels.add("Negation"); collect(expression.operand, labels); return null; }
    ...
    public List<String> visit(LogicalNot expression) { labels.add("LogicalNot"); collect(expression.operand, labels); return null; }
